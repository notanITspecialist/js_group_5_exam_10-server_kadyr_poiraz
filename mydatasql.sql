...
CREATE TABLE `comments` (
  ...
  `autor` varchar(45) DEFAULT 'anonimus',
  `comment` varchar(45) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_comments_1_idx` (`id_news`),
  CONSTRAINT `fk_comments_1` FOREIGN KEY (`id_news`) REFERENCES `news_list` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2020-02-22 19:17:32
